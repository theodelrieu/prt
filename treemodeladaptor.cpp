// taken from https://github.com/diracsbracket/qmltreeview2
...
QModelIndex TreeModelAdaptor::rootIndex() const
{
    return m_rootIndex;
}
...
QVariant TreeModelAdaptor::data(const QModelIndex &index, int role) const
{
    ...
    case HasSiblingRole:
    {
        auto ret =  modelIndex.row() != m_model->rowCount(modelIndex.parent()) - 1;
        return ret;
    }
    case ModelIndexRole:
        return modelIndex;
